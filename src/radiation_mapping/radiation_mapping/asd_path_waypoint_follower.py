...
class ASDPathWaypointFollower(Node):
    def __init__(self):
        super().__init__('asd_path_waypoint_follower')
        ...
        self.get_logger().info('ASD path waypoint follower started.')
        ...
        self.get_logger().info(
            'Waiting for /odom, path topic, dose topic, and terrain map...'
        )
    ...
    def save_result_to_csv(
        ...
        row = {
            ...
            'dose_during_path_following': f'{dose_during_path_following:.2f}',
            'executed_terrain_cost': f'{executed_terrain_cost:.2f}',
            'executed_final_coupled_score': f'{executed_final_coupled_score:.2f}',
